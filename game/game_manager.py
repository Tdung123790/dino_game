...
from constants import SCREEN, SMALL_SKINS, LARGE_SKINS, BIRD_SKINS, BG_SKINS
...
class GameManager:
    ...
    def update(self, userInput):
        ...
        if len(self.obstacles) == 0:
            ...
            if obstacle_choice == 0:
                self.obstacles.append(SmallCactus(SMALL_SKINS[skin_manager.get_skin()]))
            elif obstacle_choice == 1:
                self.obstacles.append(LargeCactus(LARGE_SKINS[skin_manager.get_skin()]))
            elif obstacle_choice == 2:
                self.obstacles.append(Bird(BIRD_SKINS[skin_manager.get_skin()]))
    ...
    def draw_background(self):
        ...
        image_width = BG_SKINS[skin_manager.get_skin()].get_width()
        SCREEN.blit(BG_SKINS[skin_manager.get_skin()], (self.x_pos_bg, self.y_pos_bg))
        SCREEN.blit(BG_SKINS[skin_manager.get_skin()], (self.x_pos_bg + image_width, self.y_pos_bg))
